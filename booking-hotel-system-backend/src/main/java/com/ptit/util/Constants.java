...
public class Constants {
  ...
  public class Url {
    ...
    public class RoomUrl {
      public static final String GET_LIST_ROOM_OF_HOTEL_NO_PAGING = "/getListRoomOfHotel";
      public static final String GET_LIST_BOOKING = "/getListBooking";
    }
    ...
    public class CommentUrl {
        public static final String UPDATE_SENTIMENT = "/updateSentiment";
      }
  ...
  public class NameColume {
    ...
    public static final String STAFF_FILTER_ROLE_ID = "staffRoleId.roleId";
    public static final String ROOM_BOOKED_ID = "roomBookedId";
    public static final String BOOKING_FILTER_STATUS_ID = "statusId.statusId";
  }
