...
public class MessageUtil {
  ...
  public static class Room {
    public static final String ROOM_ID_NOT_EXISTS = "Room id is not exists";
    public static final String ROOM_TYPE_ID_NOT_EXISTS = "Room id is not exists";
  }
  
  public static class Hotel {
	    public static final String HOTEL_ID_NOT_EXISTS = "Hotel id is not exists";
  ...
  public static final String ROOM_NO_EMPTY = "Phòng không còn trống trong khoảng thời gian";
  ...
  public static final String UPDATE_SUCCESSFULLY = "Delete successfully";
